...
class Ppspm extends CI_Controller
{
	...
	public function ditolak()
	{
		...
		$query_update = $this->db->query("UPDATE ajuan SET `catatan` = '$alasan', `status` = 'Ditolak PPSPM' WHERE `id_ajuan` = '$idajuan'");
		$query_ditolak = $this->db->query("INSERT INTO catatan SET id_ajuan = '$idajuan', oleh_role = 'PPSPM', isi_catatan = '$alasan'");
